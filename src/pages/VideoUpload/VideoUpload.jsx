                    ...
                    <div className="form-upload__right">
                      <div className="form-upload__title-wrapper">
                        <div className="form-upload__label-wrapper">
                          <label className="form-upload__label">
                            {" "}
                            ADD A VIDEO TITLE {isTitleTouched && !isTitleValid && <span className="label-error">  (Must be longer than 4 characters)</span>}
                          </label>
                        </div>
                        <div className="form-upload__input-wrapper">
                          <input
                            className={`form-upload__input form-upload__title ${isTitleTouched && !isTitleValid && 'input-invalid'}`}
                            type="text"
                      ...
                      <div className="form-upload__description-wrapper">
                        <div className="form-upload__label-wrapper">
                          <label className="form-upload__label">
                            {" "}
                            ADD A VIDEO DESCRIPTION {isDescriptionTouched && !isDescriptionValid && <span className="label-error">  (Must be longer than 10 characters)</span>}
                          </label>
                        </div>
                        <div className="form-upload__input-wrapper">
                          <textarea
                            className={`form-upload__input form-upload__description ${isDescriptionTouched && !isDescriptionValid && 'input-invalid'}`}
                            type="text"
...
//                           <label className="form-upload__label">
//                             {" "}
//                             ADD A VIDEO TITLE {titleTouched && !isTitleValid && <span className="label-error">  (Must be longer than 4 characters)</span>}
//                           </label>
//                         </div>
//                         <div className="form-upload__input-wrapper">
//                           <input
//                             className={`form-upload__input form-upload__title ${titleTouched && !isTitleValid ? 'input-invalid' : ''}`}
//                             type="text"
//                             placeholder="Add a title to your video"
//                             name="title"
//                             onChange={handleChangeTitle}
...
//                           <label className="form-upload__label">
//                             {" "}
//                             ADD A VIDEO DESCRIPTION {descriptionTouched && !isDescriptionValid && <span className="label-error">  (Must be longer than 10 characters)</span>}
//                           </label>
//                         </div>
//                         <div className="form-upload__input-wrapper">
//                           <textarea
//                             className={`form-upload__input form-upload__description ${descriptionTouched && !isDescriptionValid ? 'input-invalid' : ''}`}
//                             type="text"
//                             placeholder="Add a description to your video"
//                             rows={3}
//                             name="description"
